export const ROLES = {
  ...
  advertiser: {
    ...
    modules: ['marketplace', 'publicidade', 'chat', 'financeiro', 'grupos', 'suporte', 'planos'],
    defaultFor: 'advertiser',
  },
  driver: {
    slug: 'driver',
    label: 'Motorista',
