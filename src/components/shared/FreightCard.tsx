      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          {!disabled && isDriver && (
            <button 
              ...
              className={`p-2.5 rounded-xl transition-all z-10 ${
                isFavorite 
        ...
        <div className="flex flex-col gap-1 mb-4">
          <div className="flex items-center gap-1.5 text-blue-700">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider truncate">
              {data.company_name || data.user_name || 'Anunciante Particular'}
            </span>
          </div>
        ...
        <div className="mt-auto pt-5 border-t border-slate-50 flex items-center justify-between">
          <div>
             ...
             <p className="text-xl font-[1000] text-green-600 tracking-tighter italic leading-none">
                {formatCurrency(data.price || data.total_value)}
             </p>
          </div>
          <div className={`px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-1 ${
            disabled 
        ...
        <div className="fixed inset-0 z-[1100] flex items-center justify-center bg-slate-900/60 backdrop-blur-md p-4">
          <div className="bg-white rounded-[3rem] p-10 max-w-sm w-full text-center relative animate-in zoom-in duration-200 shadow-2xl border border-white/20">
            ...
            <p className="text-slate-500 text-sm font-bold leading-relaxed mb-8 px-4">
              Faça login para salvar seus fretes favoritos e negociar diretamente.
            </p>
            <button 
